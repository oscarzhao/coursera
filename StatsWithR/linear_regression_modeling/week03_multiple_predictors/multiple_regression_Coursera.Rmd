...
evals %>% 
  summarise(total=n(), 
            mean=mean(score), sigma=sd(score),
            iqr=IQR(score), 
            min=min(score), 
            q1 = quantile(score, 0.25),  # first quartile, 25th percentile
            median=median(score),
            q3 = quantile(score, 0.75),  # third quartile, 75th percentile
            max=max(score)
)
```

```{r score-hist}
hist(evals$score, main="Distribution of Scores", xlab = "Score", ylab = "Frequency")
```
...
```{r two-vars-eda}
# What's the relationship of professor's age(`age`) and the number of students in his/her class(`cls_students`)?
ggplot(evals, aes(x=age, y=cls_students)) + geom_point(position = "jitter")
...
```{r summary-model}
score_bty = lm(score ~ bty_avg, evals)
summary(score_bty)
```
...
plot(evals$bty_avg, score_bty$residuals)
hist(score_bty$residuals, main="Distribution of residuals", xlab = "Residuals", ylab = "Frequency")
```
Answer: I have done it wrong three times, so the choice is "Nearly normal residuals: Residuals are right skewed, but the sample size is large..."
`BE CAREFUL`
...
## reference: https://www.r-graph-gallery.com/119-add-a-legend-to-a-plot/
## reference: http://ggplot2.tidyverse.org/reference/theme.html

ggplot(evals, aes(x = bty_avg, y = score)) + 
  geom_point(aes(color = factor(gender))) + 
  labs(x = "Average Beauty", y = "Score", color="Colors") + 
...
summary(m_bty_gen)
# because p-value = 8.177e-07 << 0.05
```
...
```{r adj-rsq-select}
<<<<<<< HEAD
summary(lm(score ~ ethnicity + rank + gender + language + age + cls_perc_eval + 
    cls_students + cls_level + cls_profs + cls_credits + bty_avg, data = evals))$adj.r.squared # full

# round one
summary(lm(score ~ rank + gender + language + age + cls_perc_eval + 
    cls_students + cls_level + cls_profs + cls_credits + bty_avg, data = evals))$adj.r.squared # remove ethnicity
summary(lm(score ~ ethnicity + gender + language + age + cls_perc_eval + 
    cls_students + cls_level + cls_profs + cls_credits + bty_avg, data = evals))$adj.r.squared # remove rank
summary(lm(score ~ ethnicity + rank + language + age + cls_perc_eval + 
    cls_students + cls_level + cls_profs + cls_credits + bty_avg, data = evals))$adj.r.squared # remove gender
summary(lm(score ~ ethnicity + rank + gender + age + cls_perc_eval + 
    cls_students + cls_level + cls_profs + cls_credits + bty_avg, data = evals))$adj.r.squared # remove language
summary(lm(score ~ ethnicity + rank + gender + language + cls_perc_eval + 
    cls_students + cls_level + cls_profs + cls_credits + bty_avg, data = evals))$adj.r.squared # remove age
summary(lm(score ~ ethnicity + rank + gender + language + age + 
    cls_students + cls_level + cls_profs + cls_credits + bty_avg, data = evals))$adj.r.squared # remove cls_perc_eval
summary(lm(score ~ ethnicity + rank + gender + language + age + cls_perc_eval + 
    cls_level + cls_profs + cls_credits + bty_avg, data = evals))$adj.r.squared # remove cls_students
summary(lm(score ~ ethnicity + rank + gender + language + age + cls_perc_eval + 
    cls_students + cls_profs + cls_credits + bty_avg, data = evals))$adj.r.squared # remove cls_level
summary(lm(score ~ ethnicity + rank + gender + language + age + cls_perc_eval + 
    cls_students + cls_level + cls_credits + bty_avg, data = evals))$adj.r.squared # remove cls_profs
summary(lm(score ~ ethnicity + rank + gender + language + age + cls_perc_eval + 
    cls_students + cls_level + cls_profs + bty_avg, data = evals))$adj.r.squared # remove cls_credits
summary(lm(score ~ ethnicity + rank + gender + language + age + cls_perc_eval + 
    cls_students + cls_level + cls_profs + cls_credits, data = evals))$adj.r.squared # remove bty_avg

# so we remove cls_profs
summary(lm(score ~ ethnicity + rank + gender + language + age + cls_perc_eval + 
    cls_students + cls_level + cls_credits + bty_avg, data = evals)) # remove cls_profs

# round two
summary(lm(score ~ ethnicity + rank + gender + language + age + cls_perc_eval + 
    cls_students + cls_level + cls_credits + bty_avg, data = evals))$adj.r.squared # remove cls_profs
summary(lm(score ~ rank + gender + language + age + cls_perc_eval + 
    cls_students + cls_level + cls_credits + bty_avg, data = evals))$adj.r.squared # remove ethnicity
summary(lm(score ~ ethnicity + gender + language + age + cls_perc_eval + 
    cls_students + cls_level + cls_credits + bty_avg, data = evals))$adj.r.squared # remove rank
summary(lm(score ~ ethnicity + rank + language + age + cls_perc_eval + 
    cls_students + cls_level + cls_credits + bty_avg, data = evals))$adj.r.squared # remove gender
summary(lm(score ~ ethnicity + rank + gender + age + cls_perc_eval + 
    cls_students + cls_level + cls_credits + bty_avg, data = evals))$adj.r.squared # remove language
summary(lm(score ~ ethnicity + rank + gender + language + cls_perc_eval + 
    cls_students + cls_level + cls_credits + bty_avg, data = evals))$adj.r.squared # remove age
summary(lm(score ~ ethnicity + rank + gender + language + age + 
    cls_students + cls_level + cls_credits + bty_avg, data = evals))$adj.r.squared # remove cls_perc_eval
summary(lm(score ~ ethnicity + rank + gender + language + age + cls_perc_eval + 
    cls_students + cls_level + cls_credits + bty_avg, data = evals))$adj.r.squared # remove cls_students
summary(lm(score ~ ethnicity + rank + gender + language + age + cls_perc_eval + 
    cls_students + cls_credits + bty_avg, data = evals))$adj.r.squared # remove cls_level
summary(lm(score ~ ethnicity + rank + gender + language + age + cls_perc_eval + 
    cls_students + cls_level + bty_avg, data = evals))$adj.r.squared # remove cls_credits
summary(lm(score ~ ethnicity + rank + gender + language + age + cls_perc_eval + 
    cls_students + cls_level + cls_credits, data = evals))$adj.r.squared # remove bty_avg

# remove cls_level
summary(lm(score ~ ethnicity + rank + gender + language + age + cls_perc_eval + 
    cls_students + cls_credits + bty_avg, data = evals))  # remove cls_level

# round three
summary(lm(score ~ rank + gender + language + age + cls_perc_eval + 
    cls_students + cls_credits + bty_avg, data = evals))$adj.r.squared   # remove ethnicity
summary(lm(score ~ ethnicity + gender + language + age + cls_perc_eval + 
    cls_students + cls_credits + bty_avg, data = evals))$adj.r.squared   # remove rank
summary(lm(score ~ ethnicity + rank + language + age + cls_perc_eval + 
    cls_students + cls_credits + bty_avg, data = evals))$adj.r.squared   # remove gender
summary(lm(score ~ ethnicity + rank + gender + age + cls_perc_eval + 
    cls_students + cls_credits + bty_avg, data = evals))$adj.r.squared   # remove language
summary(lm(score ~ ethnicity + rank + gender + language + cls_perc_eval + 
    cls_students + cls_credits + bty_avg, data = evals))$adj.r.squared   # remove age
summary(lm(score ~ ethnicity + rank + gender + language + age + 
    cls_students + cls_credits + bty_avg, data = evals))$adj.r.squared   # remove cls_perc_eval
summary(lm(score ~ ethnicity + rank + gender + language + age + cls_perc_eval + 
    cls_credits + bty_avg, data = evals))$adj.r.squared   # remove cls_students
summary(lm(score ~ ethnicity + rank + gender + language + age + cls_perc_eval + 
    cls_students + bty_avg, data = evals))$adj.r.squared   # remove cls_credits
summary(lm(score ~ ethnicity + rank + gender + language + age + cls_perc_eval + 
    cls_students + cls_credits, data = evals))$adj.r.squared   # remove bty_avg

# remove rank
summary(lm(score ~ ethnicity + gender + language + age + cls_perc_eval + 
    cls_students + cls_credits + bty_avg, data = evals))   # remove rank

# round four
summary(lm(score ~ gender + language + age + cls_perc_eval + 
    cls_students + cls_credits + bty_avg, data = evals))$adj.r.squared   # remove ethnicity
summary(lm(score ~ ethnicity + language + age + cls_perc_eval + 
    cls_students + cls_credits + bty_avg, data = evals))$adj.r.squared   # remove gender
summary(lm(score ~ ethnicity + gender + age + cls_perc_eval + 
    cls_students + cls_credits + bty_avg, data = evals))$adj.r.squared   # remove language
summary(lm(score ~ ethnicity + gender + language + cls_perc_eval + 
    cls_students + cls_credits + bty_avg, data = evals))$adj.r.squared   # remove age
summary(lm(score ~ ethnicity + gender + language + age + 
    cls_students + cls_credits + bty_avg, data = evals))$adj.r.squared   # remove cls_perc_eval
summary(lm(score ~ ethnicity + gender + language + age + cls_perc_eval + 
    cls_credits + bty_avg, data = evals))$adj.r.squared   # remove cls_students
summary(lm(score ~ ethnicity + gender + language + age + cls_perc_eval + 
...
# we cannot proceed because no bigger adjusted R^2
...
>>>>>>> 0a0bda9cc9d0130b4ffc49287cacc1dae41e0ae5
```
