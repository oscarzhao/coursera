...
sfo_feb_flights %>% summarise(mean_ad=mean(arr_delay), median_ad=median(arr_delay), sd_ad=sd(arr_delay), n=n())
```
...
nycflights %>%
  summarise(delay_dep_ot_arr = sum(dep_type == "delayed" & arr_type == "on time") / n())
